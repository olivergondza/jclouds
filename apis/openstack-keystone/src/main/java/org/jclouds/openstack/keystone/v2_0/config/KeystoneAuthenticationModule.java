...
public class KeystoneAuthenticationModule extends AbstractModule {
   ...
   public static class RegionModule extends AbstractModule {
      ...
      @Provides
      @Singleton
      protected final RegionIdToURISupplier provideRegionIdToURISupplierForApiVersion(
            @Named(KeystoneProperties.SERVICE_TYPE) String serviceType, @ApiVersion String apiVersion,
      ...
      @Provides
      @Singleton
      protected final RegionIdToAdminURISupplier provideRegionIdToAdminURISupplierForApiVersion(
            @Named(KeystoneProperties.SERVICE_TYPE) String serviceType, @ApiVersion String apiVersion,
   ...
   @Provides
   @Singleton
   protected final Map<String, Function<Credentials, Access>> authenticationMethods(Injector i) {
