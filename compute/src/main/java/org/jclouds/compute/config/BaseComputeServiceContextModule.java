...
public abstract class BaseComputeServiceContextModule extends AbstractModule {
   ...
   @Provides
   @Singleton
   protected final Map<OsFamily, LoginCredentials> osFamilyToCredentials(Injector injector) {
   ...
   @Provides
   @Named("DEFAULT")
   protected final TemplateOptions provideTemplateOptions(Injector injector, TemplateOptions options) {
      return options;
   }
